...
<html>
	...
	<body>
	    ...
	    <p style="text-align: center; padding-top: 0px; margin-top: 0px; color:black;">
	    	Nomor : 422/<span style="mso-spacerun:yes">         </span>/SMPN-WE/2020
	    </p>
		...
		<div class="content">
			...
			<p>
				dari madrasah tsansawiyah pui kuningan. Demikian Surat Keterangan ini dapat digunakan untuk keperluan Penerimaan Peserta Didik Baru (PPDB) atau keperluan lain sesuai dengan kebututuhan, dan hanya berlaku sampai diterbitkannya Ijazah Tahun pelajaran 2020/2021.
			</p>
	<br>
	<br>
